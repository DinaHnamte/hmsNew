...
namespace common\modules\userspage\controllers;
...
use hospital\models\LoginForm;
use hospital\models\ContactForm;
use hospital\models\SignupForm;
...
class DefaultController extends Controller
{
    ...
    {
        $model = RegUser::find()->where(['id' => $id])->one();
    ...
    {
        return $this->render('view-tenant', [
    ...
    public function actionCreateTenant()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post())) {
                ...
                $model->save();
                return $this->redirect(['view-tenant', 'id' => $model->id]);
            }
        } else {
        ...
        $model->id =$id;
        $model->regby_id = $this->request->get('id');
    ...
    public function actionUpdateTenant($id)
    {
        ...
        if ($this->request->isPost && $model->load($this->request->post()) && $model->save()) {
            return $this->redirect(['viewTenant', 'id' => $model->id]);
        }

        return $this->render('update-tenant', [
            'model' => $model,
        ]);
    }
