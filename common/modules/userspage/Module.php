...
namespace common\modules\userspage;
...
class Module extends \yii\base\Module
{
     ...
     * {@inheritdoc}
     */
    public $controllerNamespace = 'common\modules\userspage\controllers';
    /**
     * {@inheritdoc}
     */
    public function init()
    {
        ...
        $this->modules = [
            'utils' => [
                'class' => 'common\modules\utils\Module',
                'defaultUrl' => '/userspage/',
                'defaultUrlLabel' => 'MyHome',
            ],
        ];
    }
